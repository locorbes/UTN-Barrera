...
<div class="jumbotron jumbotron-fluid">
  <div class="container text-center">
    <h1 class="display-3 text-blue"><-ERROR 404-></h1>
    <p class="lead">No se ha podido establecer conexión con el recurso solicitado. </p>
    <a href="#">
        <button type="button" class="btn btn-sm btn-outline-secondary">VOLVER AL INICIO</button>
      </a>
  </div>
</div>
